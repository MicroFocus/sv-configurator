...
public class ServiceAnalysisTest {
    ...
    public void testJaxb() throws Exception {
        ...
        InputStream is = Resources.getResourceStream("test/jaxb/serviceAnalysis.xml");

        ServiceAnalysis sa = proc.unmasrhall(is, ServiceAnalysis.class);

        assertEquals("state error", ServiceAnalysis.State.CANCELLED, sa.getState());
    }
