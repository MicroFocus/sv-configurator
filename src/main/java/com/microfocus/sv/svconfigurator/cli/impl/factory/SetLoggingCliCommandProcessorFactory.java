...
public class SetLoggingCliCommandProcessorFactory extends AbstractCLICommandProcessorFactory {
    ...
    public SetLoggingCliCommandProcessorFactory(ICommandExecutorFactory commandExecutorFactory) {
    ...
    public ICLICommandProcessor create() {
        SetLoggingCliCommandProcessor cliProc = new SetLoggingCliCommandProcessor();
        return cliProc;
