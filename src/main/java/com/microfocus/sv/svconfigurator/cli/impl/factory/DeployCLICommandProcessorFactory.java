...
public class DeployCLICommandProcessorFactory extends AbstractCLICommandProcessorFactory {
    ...
    public DeployCLICommandProcessorFactory(ICommandExecutorFactory commandExecutorFactory) {
    ...
    public ICLICommandProcessor create() {
        IDeployProcessor proc = new DeployProcessor(this.commandExecutorFactory);
        IProjectBuilder projectBuilder = new ProjectBuilder();
        return new DeployCLICommandProcessor(projectBuilder, proc);
