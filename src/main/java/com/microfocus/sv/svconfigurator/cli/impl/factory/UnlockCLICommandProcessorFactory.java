...
public class UnlockCLICommandProcessorFactory extends AbstractCLICommandProcessorFactory {

    private static final String DESCRIPTION = "Unlocks the service on the server";

    private ICommandExecutorFactory commandExecutorFactory = null;

    public UnlockCLICommandProcessorFactory(ICommandExecutorFactory commandExecutorFactory) {
        super(UnlockCLICommandCliProcessor.COMMAND, DESCRIPTION);
    ...
    public ICLICommandProcessor create() {
        IUnlockProcessor proc = new UnlockProcessor(this.commandExecutorFactory);
        IProjectBuilder projectBuilder = new ProjectBuilder();
        return new UnlockCLICommandCliProcessor(projectBuilder, proc);
    }
}
