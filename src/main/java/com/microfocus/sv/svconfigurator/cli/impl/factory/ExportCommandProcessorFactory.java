...
public class ExportCommandProcessorFactory extends
    ...
    public ExportCommandProcessorFactory(ICommandExecutorFactory commandExecutorFactory) {
    ...
    public ICLICommandProcessor create() {
        ...
        return new ExportCommandProcessor(new ExportProcessor(commandExecutorFactory), projectBuilder);
    }
}
