...
public class HotSwapCLICommandProcessorFactory extends AbstractCLICommandProcessorFactory {
    ...
    public HotSwapCLICommandProcessorFactory(ICommandExecutorFactory commandExecutorFactory) {
    ...
    public ICLICommandProcessor create() {
        IHotSwapProcessor proc = new HotSwapProcessor(this.commandExecutorFactory);
        IProjectBuilder projectBuilder = new ProjectBuilder();
        return new HotSwapCLICommandProcessor(projectBuilder, proc);
    }
