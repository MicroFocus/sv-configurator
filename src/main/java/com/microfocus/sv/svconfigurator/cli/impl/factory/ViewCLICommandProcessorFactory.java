...
public class ViewCLICommandProcessorFactory extends AbstractCLICommandProcessorFactory {

    private static final String DESCRIPTION = "Prints the info about a service on the server.";

    private ICommandExecutorFactory commandExecutorFactory = null;

    public ViewCLICommandProcessorFactory(ICommandExecutorFactory commandExecutorFactory) {
        super(ViewCLICommandProcessor.COMMAND, DESCRIPTION);
    ...
    public ICLICommandProcessor create() {
        IViewProcessor proc = new ViewProcessor(this.commandExecutorFactory);
        IProjectBuilder projectBuilder = new ProjectBuilder();
        return new ViewCLICommandProcessor(projectBuilder, proc);
    }
}
