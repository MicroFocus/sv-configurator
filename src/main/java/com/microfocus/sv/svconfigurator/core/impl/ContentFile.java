...
public class ContentFile extends AbstractProjectElement implements IContentFile {

    public ContentFile(String id, String name, IProjectElementDataSource ds, EncryptionMetadata encryptionMetadata, String projectPassword) {
