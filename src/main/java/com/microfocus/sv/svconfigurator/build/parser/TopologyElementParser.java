...
import com.microfocus.sv.svconfigurator.core.impl.Topology;
import com.microfocus.sv.svconfigurator.core.impl.exception.SVCParseException;

public class TopologyElementParser extends AbstractXMLElementParser {
    ...
    private static final String FILE_EXTENSION = ".vsdt";
    ...
    public IProjectElement create(IProjectElementDataSource ds, XMLEventReader reader, String projectPassword) throws SVCParseException, XMLStreamException {
        ...
        return new Topology(null, null, null);
    }
