...
public class ServiceDescriptionElementParser extends AbstractXMLElementParser {

    //============================== STATIC ATTRIBUTES ========================================

    public static final String FILE_EXTENSION = ".vsdsc";
    private static final String ROOT_EL = "serviceDescription";
    ...
    public IProjectElement create(IProjectElementDataSource ds, XMLEventReader reader, String projectPassword) throws SVCParseException, XMLStreamException {
        ...
        return new ServiceDescription(id, name, ds, readEncryptionMetadata(reader), projectPassword);
    }
