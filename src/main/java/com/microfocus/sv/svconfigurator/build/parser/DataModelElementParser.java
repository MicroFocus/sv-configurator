...
public class DataModelElementParser extends AbstractXMLElementParser {

    public static final String FILE_EXTENSION = ".vsmodel";
    private static final String ELEMENT_NAME = "dataModel";
    ...
    public IProjectElement create(IProjectElementDataSource ds, XMLEventReader reader, String projectPassword) throws SVCParseException, XMLStreamException {
        StartElement el = AbstractXMLElementParser.skipToElement(reader, ELEMENT_NAME);
        String id = AbstractXMLElementParser.getAttributeValue(el, ATTRIBUTE_ID, false);
        String name = AbstractXMLElementParser.getAttributeValue(el, ATTRIBUTE_NAME, true);
        return new DataModel(id, name, ds, readEncryptionMetadata(reader), projectPassword);
    }
