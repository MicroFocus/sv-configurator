...
import com.microfocus.sv.svconfigurator.core.impl.ContentFile;
...
public class ContentFileElementParser extends AbstractXMLElementParser {

    //============================== STATIC ATTRIBUTES ========================================

    private static final String ROOT_EL = "contentFile";
    ...
    public IProjectElement create(IProjectElementDataSource ds, XMLEventReader reader, String projectPassword) throws SVCParseException, XMLStreamException {
        ...
        return new ContentFile(id, name, ds, readEncryptionMetadata(reader), projectPassword);
    }

    @Override
    public boolean isParserForDataSource(IProjectElementDataSource ds) {
        return ds instanceof ContentFileElementDataSource;
    }
