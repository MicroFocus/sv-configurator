...
public interface IUndeployProcessor {
    
    void process(UndeployProcessorInput input, ICommandExecutor executor) throws CommunicatorException, CommandExecutorException;
