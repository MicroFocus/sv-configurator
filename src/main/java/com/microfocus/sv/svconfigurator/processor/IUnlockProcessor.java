...
/**
 * Interface of Unlock command processor
 */
public interface IUnlockProcessor {

    void process(UnlockProcessorInput input, ICommandExecutor executor)  throws CommunicatorException, CommandExecutorException;
