...
public interface IHotSwapProcessor {
    
    void process(HotSwapProcessorInput input, ICommandExecutor executor) throws CommunicatorException, CommandExecutorException;
